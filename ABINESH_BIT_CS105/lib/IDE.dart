...
class _IDEState extends State<IDE> {
  ...
  @override
  void initState() {
    APIHandler.getLanguages().then((languagesList) {
                  ...
                  children: [
                    ...
                    MaterialButton(
                      ...
                      onPressed: () async {
                        ...
                        String token = await APIHandler.createSubmission(
                            codeAreaController.text, selectedLanguage.iD);
                        // print(' Token : $token');
                        OutPutModel codeOutput =
                            await APIHandler.getSubmission(token);
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Text(
            ' OutPut : \n \n $output',
            style: TextStyle(color: hasOutputError ? Colors.red : Colors.black),
          ),
        ),
      ),
    );
